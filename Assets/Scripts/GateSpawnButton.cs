...
public class GateSpawnButton : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Instantiate(GateToSpawn, transform);
    }
    public void SpawnGate()
    {
        if (spawned) return;
        spawnedGate = Instantiate(GateToSpawn, MainMeniAI.MM.currentLevel.transform);
        spawned = true;
    }
